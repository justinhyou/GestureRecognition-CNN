...
def classify(trained_model_dir, test_data_dir, results_path):
    ...
    with open(os.path.join(results_path, results_name), 'w') as file:
        ...
        for i in range(len(y_classes)):
            writer.writerow((ids[i], y_probabilities[i][0], y_probabilities[i][1], y_probabilities[i][2], \
                            y_probabilities[i][3], y_probabilities[i][4], y_probabilities[i][5], \
                            y_probabilities[i][6], y_probabilities[i][7], y_probabilities[i][8], \
                            y_probabilities[i][9], y_classes[i] ))
